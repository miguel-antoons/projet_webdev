...
(
    ...
    LANGUE_CLIENT BIT not null default 0, -- le domaine casse les couilles
    NOM_ARCHITECT VARCHAR(50),
    TITRE_CLIENT BIT NOT NULL,
...
create table articles (
    ...
    PRIX_1 FLOAT(11, 4) NOT NULL,
    PRIX_2 FLOAT(11, 4) NULL DEFAULT 0,
    PRIX_3 FLOAT(11, 4) NULL DEFAULT 0,
    CODE_RACCOURCI varchar(15) NOT NULL,
    PRESENTATION_DEVIS BOOLEAN NOT NULL DEFAULT 0,
    LIBELLE_FR_PLURAL VARCHAR(255) NULL,
    LIBELLE_NL_PLURAL VARCHAR(255) NULL,
...
create table articles_rgie (
    ...
    PRIX_1 FLOAT(12,5) NOT NULL DEFAULT 0,
